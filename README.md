...
виявився щасливим, і ноутбук це чесно показує.
...
├── README.md                  ← ви тут
├── notebooks/
│   └── triage-research.ipynb  оригінальний дослідницький ноутбук (недоторканий)
├── docs/                      повний переказ ноутбука, розбитий на 18 розділів
│   ├── README.md              зміст і навігація по розділах
│   ├── 00…15-*.md             пояснення + код + результати + графіки
