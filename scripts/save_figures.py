...
Графіки відтворюються повністю з коду: скрипт бере дані й алгоритми з
публічного API `triage_sim`, будує кожен графік і пише його у файл.
...
тож повний прогін триває ~хвилину.
"""
...
def main():
    ...
    parser.add_argument("--runs", type=int, default=300,
                        help="к-ть прогонів Монте-Карло/harm/reneging/deter (типово 300)")
