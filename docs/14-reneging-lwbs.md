...
[← Фаза 11. Метрика шкоди: від хвилин до життів](13-harm-metric.md)    [Фаза 13. Динамічна тяжкість: погіршення і смерть →](15-dynamic-severity.md)
...
def assign_patience(patients, seed=0):
    ...
    return patients
```
Додає кожному пацієнту властивість `patient.patience` — його особистий поріг:
