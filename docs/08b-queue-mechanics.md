...
[← Фаза 7. Висновки та пропускна здатність](08-throughput.md)    [Фаза 8. Валідація рушія (M/G/1, M/M/c) →](09-validation.md)
...
Ідеальна послідовність викладу: спочатку показати число **703 хв** (Графік 3), а потім цей малюнок — "ось **як саме** воно утворюється, крок за кроком".
...
|---|---|
| **Чисті** push/pop (ізольовано) | ~35 разів |
| **Повна** симуляція | практично без різниці (~1×) |
...
**Для цього навчального проєкту** вибір купи виправданий: він уніфікує код і підкреслює головну ідею — *FIFO це купа з пріоритетом = час прибуття*. А цей відступ показує, що ми **свідомо** обрали такий підхід і розуміємо альтернативу.
