...
- **три кольори** в кожній групі: 🔵 FIFO, 🟢 Priority, 🟣 Aging.
...
Цей графік — **серце всього дослідження**: в одній картинці він показує всю суть.
...
**3. Зрозумілий без підпису.** Графік одразу чіпляє оком, не потребує пояснень (усе видно з форми стовпчиків) і провокує природне питання ("чому зелений такий високий праворуч?").

**4. Він чесний.** Поверхневе подання показало б лише, що "Priority — це круто". Цей графік показує і плюс, і мінус — це викликає довіру до автора як до інженера, що розуміє нюанси.
...
**Чому це цінно.** Графік 1 переконує цифрами, Графік 2 — картинкою людських історій. Коли читач бачить суцільну сіру смугу 564 хв поряд із "пролітаючими" сусідами — це б'є сильніше за статистику.
